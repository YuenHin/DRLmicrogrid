...
class FA:
    ...
    def __set_C(self):
        ...
        for i in range(0, 6):  # 0点至6点
            self.c[i] = -0.8 * 0.5 * 0.7 * 0.1
            self.c[i + self.time_num] = -0.8 * 0.5 * 0.7 * 0.1
            # self.c[i] = -0.028
            # self.c[i + self.time_num] = -0.028
        for i in range(6, 13):  # 7点至13点
            self.c[i] = -0.8 * 1.8 * 0.7 * 0.1
            self.c[i + self.time_num] = -0.8 * 1.8 * 0.7 * 0.1
            # self.c[i] = -0.048
            # self.c[i + self.time_num] = -0.048
        for i in range(13, 16):  # 14点至16点
            self.c[i] = -0.8 * 0.7 * 0.1
            self.c[i + self.time_num] = -0.8 * 0.7 * 0.1
            # self.c[i] = -0.038
        ...
        # 天然气子系统
        for i in range(0, 6):
            self.c[i + self.time_num * 2] = -0.7 * 0.9 * 0.7 * 0.1
            self.c[i + self.time_num * 3] = -0.7 * 0.9 * 0.7 * 0.1
            # self.c[i + self.time_num * 2] = -0.02
            # self.c[i + self.time_num * 3] = -0.02
        for i in range(6, 13):
            self.c[i + self.time_num * 2] = -0.7 * 1.1 * 0.7 * 0.1
            self.c[i + self.time_num * 3] = -0.7 * 1.1 * 0.7 * 0.1
            # self.c[i + self.time_num * 2] = -0.04
            # self.c[i + self.time_num * 3] = -0.04
        for i in range(13, 16):
            self.c[i + self.time_num * 2] = -0.7 * 0.7 * 0.1
            self.c[i + self.time_num * 3] = -0.7 * 0.7 * 0.1
        ...
        # 热能子系统
        for i in range(0, 6):
            self.c[i + self.time_num * 4] = -0.7 * 0.9 * 0.6 * 0.1
            self.c[i + self.time_num * 5] = -0.7 * 0.9 * 0.6 * 0.1
            # self.c[i + self.time_num * 4] = -0.023
            # self.c[i + self.time_num * 5] = -0.023
        for i in range(6, 13):
            self.c[i + self.time_num * 4] = -0.7 * 1.1 * 0.6 * 0.1
            self.c[i + self.time_num * 5] = -0.7 * 1.1 * 0.6 * 0.1
            # self.c[i + self.time_num * 4] = -0.043
            # self.c[i + self.time_num * 5] = -0.043
        for i in range(13, 16):
            self.c[i + self.time_num * 4] = -0.7 * 0.6 * 0.1
            self.c[i + self.time_num * 5] = -0.7 * 0.6 * 0.1
        ...
        # 冷能子系统
        for i in range(0, 6):
            self.c[i + self.time_num * 6] = -0.7 * 0.9 * 0.5 * 0.1
            self.c[i + self.time_num * 7] = -0.7 * 0.9 * 0.5 * 0.1
            # self.c[i + self.time_num * 6] = -0.021
            # self.c[i + self.time_num * 7] = -0.021
        for i in range(6, 13):
            self.c[i + self.time_num * 6] = -0.7 * 1.1 * 0.5 * 0.1
            self.c[i + self.time_num * 7] = -0.7 * 1.1 * 0.5 * 0.1
            # self.c[i + self.time_num * 6] = -0.041
            # self.c[i + self.time_num * 7] = -0.041
        for i in range(13, 16):
            self.c[i + self.time_num * 6] = -0.7 * 0.5 * 0.1
            self.c[i + self.time_num * 7] = -0.7 * 0.5 * 0.1
