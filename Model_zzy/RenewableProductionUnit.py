...
class RT:
    ...
    def __getHPData(self):
        self.p = self.__24to96("C:\software\Github\DRLmicrogrid\Data\RE\HP.xls", 2)
...
class HP:
    ...
    def constraints(self, constraint_information_class):
        ...
        CreatConstraintsByText(self.time_num, power_constraint_h, self.min_output_h, self.max_output_h,
                               constraint_information_class)
