        ...
        for env_id in range(self.num_tasks):
            for i in range(self.num_each_envs):
                ...
                self.object_dof.append(
                    self.gym.get_asset_dof_count(object_assets[env_id])
                )
                self.object_rigid_body.append(
                    self.gym.get_asset_rigid_body_count(object_assets[env_id])
                )
                ...
                goal_handle = self.gym.create_actor(
                    ...
                    "goal_object",
                    index + self.num_envs * len(self.task_envs),
                    0,
                    0,
                )
