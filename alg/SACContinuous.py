...
class SACContinuous:
    ...
    def save_network(self, name='test'):
        pass
        #保存模型参数
        # torch.save(self.actor.state_dict(), '.\save_model\SAC_actor_network_' + str(name) + '.pkl')
        # torch.save(self.critic_1.state_dict(), '.\save_model\SAC_critic_1_network_' + str(name) + '.pkl')
        # torch.save(self.critic_2.state_dict(),'.\save_model\SAC_critic_2_network_' + str(name) + '.pkl')

    def load_network(self, name='test'):
        pass
        # self.actor.load_state_dict(torch.load('.\save_model\SAC_actor_network_' + str(name) + '.pkl'))
        #
        # self.critic_1.load_state_dict(torch.load('.\save_model\SAC_critic_1_network_' + str(name) + '.pkl'))
        # self.target_critic_1.load_state_dict(torch.load('.\save_model\SAC_critic_1_network_' + str(name) + '.pkl'))
        #
        # self.critic_2.load_state_dict(torch.load('.\save_model\SAC_critic_2_network_' + str(name) + '.pkl'))
        # self.target_critic_2.load_state_dict(torch.load('.\save_model\SAC_critic_2_network_' + str(name) + '.pkl'))
