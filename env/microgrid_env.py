    ...
    def step3(self, action, cur_episode):
        while True:
            ...
            if res.success == False:
                #PrintBounds(self.flash_num)
                print("无解了！！！！！！！！！")
                return res.x, np.array([0]), done, False, action_
            # self.__remember_S()
            self.__get_action_SE_nocontrol()
