...
for i in range(50):
    ...
    if save_Model is True:
        agent.save_network(name=str(num_episodes) + 'ori' + str(g))
    ...
    plt.savefig('.\savefig\SAC on {}'.format(str(num_episodes) + '_ori' + str(g)) + '.png')
    plt.clf()

    agent.save_returnlist(str(num_episodes) + '_SAC_ori' + str(g), return_list)
