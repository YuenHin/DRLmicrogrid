...
"创建一个发电厂"
CPP_e_01 = CPP("CPP_e_01", 1, 6000, time_num=time)

"创建一个DG"
DG = DG("DG_01", 1, demand_total*0.4, -0.06, time_num=time)

"创建一个光伏发电厂"
PV = RT("PV_01", "PV", 2, -0.048, demand_total, time_num=time)

"创建一个风力发电厂"
WT = RT("WT_01", "WT", 1, -0.033, demand_total, time_num=time)
...
line_CPP_D = Line("L_e_02", 50000, -0.0001, Single=False, MG_point=True, from_MG="CPP", to_MG="MG", time_num=time)
