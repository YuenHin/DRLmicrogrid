...
from Model_zzy_RO.Node import Node
from Model_zzy_RO.ConventionalPowerPlants_area import CPP
from Model_zzy_RO.GasWell import GW
...
from Model_zzy_RO.Multi_Microgrid import MMGs
from Model_zzy_RO.Line import Line
from MILP import PrintBounds
from Model_zzy_RO.Flexible_load import FL
from Model_zzy_RO.Flexible_demand import FD
...
gw_01 = GW("gw_01", id=1, total_production=20000, production_price=1.2, time_num=time)
